...
class Light_Graph           /// This class allows to represent graphs with adjacency list
{
  protected :
    ...
    // basic operations or functions on graphs
        ...
        void Load_TW (int nb_vertices, const vector<pair<int, int>>& edges);            ///< reads the graphical structure from the file filename containing a graph instance (in TW format)
};
